...
public class ScaryMaze extends JPanel implements Runnable, MouseMotionListener {
	...
	ScaryMaze() throws Exception {
		...
		maze = ImageIO.read(getClass().getResource("Grace Knickrehm.jpg"));
	...
	int endColor= -4448348;
	if (mouseColor == endColor){
				
				// pop up a message to tell them they won
	JOptionPane.showInputDialog("Congradulations you have completed the game.");
	}
	}
	...
	private void scare() {
		...
		AudioClip sound = JApplet.newAudioClip(getClass().getResource("Clownlaugh.wav"));
